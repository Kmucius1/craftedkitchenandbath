...
export const metadata: Metadata = {
  ...
  description:
    "Crafted Kitchen & Bath stands behind its work. A licensed, insured Tampa Bay remodeler (CGC1541816) committed to craftsmanship you can count on.",
...
const points = [
  { title: "Licensed & Insured", body: "Crafted Kitchen & Bath is a licensed Florida contractor (CGC1541816). You're protected by working with a properly licensed, insured professional — not an unlicensed handyman." },
